...
urlpatterns = [
    ...
    path('', views.NetworkScanningSessionListView.as_view(), name='list-session'),
    ...
    path('remove-down-server/<int:pk>', views.NetworkScanningSessionRemoveDownServer.as_view(), name='delete-session-down-server'),
]